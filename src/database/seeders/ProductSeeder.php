    ...
    public function run(): void
    {
        $products = [
            [
                ...
                'image_path'  => 'products/sample_kiwi.jpg',
            ],
            [
                'name'        => 'ストロベリー',
                'price'       => 1200,
                ...
                'image_path'  => 'products/sample_strawberry.jpg',
            ],
            [
                'name'        => 'オレンジ',
                'price'       => 850,
                ...
                'image_path'  => 'products/sample_orange.jpg',
            ],
            [
                'name'        => 'スイカ',
                'price'       => 700,
                ...
                'image_path'  => 'products/sample_suika.jpg',
            ],
            [
                'name'        => 'ピーチ',
                'price'       => 1000,
                ...
                'image_path'  => 'products/sample_peach.jpg',
            ],
            [
                'name'        => 'シャインマスカット',
                'price'       => 1400,
                ...
                'image_path'  => 'products/sample_muscat.jpg',
            ],
            [
                'name'        => 'パイナップル',
                'price'       => 800,
                ...
                'image_path'  => 'products/sample_pineapple.jpg',
            ],
            [
                'name'        => 'ブドウ',
                'price'       => 1100,
                ...
                'image_path'  => 'products/sample_grape.jpg',
            ],
            [
                'name'        => 'バナナ',
                'price'       => 600,
                ...
                'image_path'  => 'products/sample_banana.jpg',
            ],
            [
                'name'        => 'メロン',
                'price'       => 900,
                ...
                'image_path'  => 'products/sample_melon.jpg',
            ],
        ];
